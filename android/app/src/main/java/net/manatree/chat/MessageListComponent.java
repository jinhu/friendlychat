...
public class MessageListComponent {
    ...
    public MessageListComponent(final MainActivity anActivity, RecyclerView aRecyclerView) {
        mMessageRecyclerView = aRecyclerView;
        mLinearLayoutManager = new LinearLayoutManager(anActivity);
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<FriendlyMessage, MessageViewHolder>(
            ...
            protected void populateViewHolder(MessageViewHolder viewHolder, FriendlyMessage friendlyMessage, int position) {
                anActivity.mProgressBar.setVisibility(ProgressBar.INVISIBLE);
                viewHolder.messageTextView.setText(friendlyMessage.getText());
                viewHolder.messengerTextView.setText(friendlyMessage.getName());
                if (friendlyMessage.getPhotoUrl() == null) {
                    viewHolder.messengerImageView.setImageDrawable(ContextCompat.getDrawable(anActivity,
